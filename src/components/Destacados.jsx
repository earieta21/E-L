            ...
            <div className={Style.container}>
              {itemsToDisplay.map((producto, index) => (
                <div key={index} className={Style.item}>
                  ...
                  <button onClick={() => abrir(producto)} className={Style.button}>Ver Producto</button>
                  <button onClick={() => addToCart(producto)} className={Style.agregar}>Agregar al Carrito</button>
                </div>
              ))}
            </div>
          </div>
